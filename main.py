...
import Luus_Jaakola_method_question3 as LJ_3
import math
...
if __name__ == "__main__":
 ...
 # ------Assignment 3 question 3 --------
    ...
    extremum, best_cost, path = LJ_3.luus_jaakola_optimize(function, initial_guess, r, bounds, constraint, innerloop_iterations,outloop_iterations, search_space_reduction_factor)
    print("extremum:", extremum)
    print("Objective function value at extremumn:", best_cost)
