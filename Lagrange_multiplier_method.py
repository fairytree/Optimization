...
if __name__ == "__main__":
    ...
    # constraint = constraint_3(variables)
    ...
    # # gradient_eq = [sp.diff(constraint_eq, var) for var in variables]
    # # print("gradient of equal constraint: ", sp.latex(gradient_eq))
    ...
    for i in range(len(extrema)):
        ...
        print("objective function value:", objective_func(extrema[i]))

    # print("objective function value:", objective_func([3,-1]))